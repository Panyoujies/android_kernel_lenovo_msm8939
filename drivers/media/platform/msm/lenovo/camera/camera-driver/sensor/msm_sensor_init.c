...
/* Logging macro */
#define CONFIG_MSM_SENSOR_INIT

#undef CDBG
#ifdef CONFIG_MSM_SENSOR_INIT
...
extern int stmvl6180_init(void);
#endif
	...
	void *arg)
{
	...
	case CFG_SINIT_PROBE_DONE:
        ...
        pr_err("%s:wk_log:CFG_SINIT_PROBE_DONE E\n",__func__);
		break;

	case CFG_SINIT_PROBE_WAIT_DONE:
		msm_sensor_wait_for_probe_done(s_init);
        pr_err("%s:wk_log:CFG_SINIT_PROBE_WAIT_DONE E\n",__func__);
		break;
