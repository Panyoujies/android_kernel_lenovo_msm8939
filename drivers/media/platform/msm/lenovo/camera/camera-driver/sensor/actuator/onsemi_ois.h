...
//#define	OISFW_RELEASE_VER (0xA2A2)	//LC898122A FW
//#define	OISFW_RELEASE_VER (0xA3A3)	//LC898122A FW
//#define	OISFW_RELEASE_VER (0xA4A4)	//LC898122A FW
#define	OISFW_RELEASE_VER (0xA5A5)	//LC898122A FW
//#include  <windows.h>
...
#define		GXQ_INI				0x3F800000
#define		GYQ_INI				0x3F800000
...
#define		DIFIL_S2_4DS	0x3F7FF600
...
#ifdef	CATCHMODE
#define	FS_SEL		2			/* 175LSB  /DPS : IDG2030 */
#else	//CATCHMODE
/* Select Gyro Sensor */
...
//#define	FS_SEL		3		/* 87.5LSB /DPS  */
 ...
 #ifdef		PT_TEST_09
 #define		GYRLMT4_S1		0x40D33333 	// 6.600F  
 #define		GYRLMT4_S2		0x40D33333	// 6.600F  
 #else		//PT_TEST_09
...
K7_OISINI__ unsigned long	UlH1Coefval ;		// H1 coefficient value
 ...
 #else	//CATCHMODE
   #define		MAXLMT			0x401F2EA4				// 2.48722 (pm 0.7000)  //3F7FFC00(0.99994) --> 3F7FE000(0.9995117)
   #define		MINLMT			0x00000000				// 0.00000 (pm 0.0000)  //3F7FFD80(0.99996) --> 3F7FEC40(0.9996986)
   #define		CHGCOEF			0xB71A639E				// -0.000009
   #define		CHGCOEF_4DS		0xB81A639E				// -0.000037
   
   #define		MAXLMT_MOV		0x409F2EA4				// 4.97444 (pm 1.4000)  //3F7FF600(0.99985) --> 3F7FB000(0.9987793)
   #define		MINLMT_MOV		0x00000000				// 0.00000 (pm 0.0000)  //3F7FFD80(0.99996) --> 3F7FEC40(0.9996986)
   #define		CHGCOEF_MOV		0xB7C0FC86				// -0.000023		//140314
   #define		CHGCOEF_MOV_4DS	0xB8C0FC86				// -0.000092
 #endif	//CATCHMODE
