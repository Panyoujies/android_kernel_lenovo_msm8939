...
/*lenovo-sw jixj 2014.11.26 add*/
static struct smem_nv gsmem_nv;
...
static struct smem_nv * smem_read_nv(void)
{
	...
	/*lenovo-sw jixj 2014.11.26 modified begin*/
	#if 0
	return buf;
	#else
	gsmem_nv = *buf;
	return &gsmem_nv;
	#endif
	/*lenovo-sw jixj 2014.11.26 modified end*/
}
...
static int __init lephone_nv_init(void)
{
	show_nv();
   return 0;
}

/*lenovo-sw jixj 2014.11.10 add begin*/
late_initcall(lephone_nv_init);

MODULE_LICENSE("Dual BSD/GPL");
MODULE_AUTHOR("Ji Xiaojun <jixj@lenovo.com>");
MODULE_DESCRIPTION("Lephone nv");
/*lenovo-sw jixj 2014.11.10 add end*/
